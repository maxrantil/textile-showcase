// src/components/gallery/GalleryContainer.tsx - Fixed
'use client'
...
const GalleryContainer = forwardRef<HTMLDivElement, GalleryContainerProps>(
  function GalleryContainer(
    { children, isRestoring, onTouchStart, onTouchMove, onTouchEnd },
    ref
  ) {
      ...
      >
        <div
          ...
          style={{
            ...
            paddingBottom: breakpoint === 'mobile' ? '120px' : '60px',
            ...
            // Smooth restoration - hide during restoration, then fade in
...
// Add display name to avoid React dev tools warnings
