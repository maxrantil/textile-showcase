...
export function generateProjectStructuredData(project: TextileDesign, slug: string) {
  return {
...
export function createProjectImageUrl(project: TextileDesign, options = { width: 1200, height: 630, quality: 90 }) {
